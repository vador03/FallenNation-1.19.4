...
execute store result entity @s Motion[0] double 0.1 run scoreboard players operation @s gth.x2 -= @s gth.x1
execute store result entity @s Motion[1] double 0.1 run scoreboard players operation @s gth.y2 -= @s gth.y1
execute store result entity @s Motion[2] double 0.1 run scoreboard players operation @s gth.z2 -= @s gth.z1
data modify entity @s damage set value 2.25
